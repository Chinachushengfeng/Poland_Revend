...
// getcharity?lang=zh
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://188.125.156.176:8080/rvm/public/urlget/user_transaction.php'); //這裏是判斷網絡狀況
...
$auth_url = "http://188.125.156.176:8080/rvm/public/urlget/getbarcode.php?mid=".$mid; 
$ch = curl_init();
...
$temp_data['taxableAmount'] =number_format($temp_data['grossAmount']-$temp_data['gstAmount'],4); 
 ...
 $auth_url = 'http://rvmback.com/poland/public/urlget/api/transaction.php'; 
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $auth_url);
...
$auth_url = "http://188.125.156.176:8080/rvm/public/urlget/getnewad.php?mid=".$result['mid'] ;

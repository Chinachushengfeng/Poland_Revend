...
document.addEventListener('dragstart', e => e.preventDefault());   // 禁止拖动
        ...
        <div class="content">
            ...
            <div class="content-body">
                ...
                <div class="content-body-left">
                   ...
                   <a href="http://127.0.0.1/tjt/"     > <div class="btn"><img src="../assets/image/arror-left.svg" alt="" class="arror"> POWRÓT</div></a>
                </div>
                <!-- 右边回收信息表格 -->
                <div class="content-body-right">
                    <div class="content-body-right-table">
                        ...
                        <div class="tableRow limit">
                            <p>Limit butelek/puszek: </p><span>30</span>
                        </div>
                    </div>
                    <!-- 下一个按钮 -->
                   <a href="http://127.0.0.1/tjt/recycle/gowaiting.php"     >    <div class="content-body-right-btn">DALEJ <img src="../assets/image/arror-right.svg" alt=""
                            class="arror"></div></a>
                </div>
            </div>
        </div>
 ...
 include("incdb.php");
		...
		$sql = "update command set bottle=0,can=0,statecode=1,limitedvalue=30"; 

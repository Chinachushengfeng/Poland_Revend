...
<head>
  ...
  <meta http-equiv="refresh" content="2;url=http://127.0.0.1/tjt/recycle/dorecycle.php" />
...
$sql = "update command set transactionid='$transactionid' ,command=1,userscan=123"; //標記結束transaction    //每次在載入首頁時候會檢查是否有0標記並上傳。

...
///////////////////////////////////清空//////////////////////////////////////////////////////////////////////
	...
	$url='http://188.125.156.176:8080/groszek/public/urlget/alipaysearch.php';
...
//		 echo var_dump($response);
 ...
 error_reporting(0);
     ...
     $sql = "update ocl set value='$value' "; //清空ocl
		mysqli_query($link, $sql);
...
else
{
 ...
 // echo select('Daily Rebate Limit：');  修改1228
  ...
  echo ' <span   style="border-radius:10px;font-size:26px;right:5% " > Twoje punkty：' . number_format($value ).'</span>';

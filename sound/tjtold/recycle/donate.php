...
<!--- <body leftmargin=0 topmargin=0 oncontextmenu='return false' ondragstart='return false' onselectstart ='return false' onselect='document.selection.empty()' oncopy='document.selection.empty()' onbeforecopy='return false' onmouseup='document.selection.empty()'>  
 ...
 <strong  style="font-size:48px;font-weight:bold"><b>Odbiór elektroniczny<br> </strong>
</div>
 ...
 <table width=113%  style="margin-top:30px;margin-left:55px" >
 	...
 	<td   align="left" style="font-size:25px  " >Identyfikator transakcji:  
...
<?php 
	...
	$sql="select * from command ";
 	...
 	<td width=40% align="left" style="font-size:25px  " > 
       ...
       <div align="center" style="font-size:20px"> W razie potrzeby zrób zdjęcie na potwierdzeniu elektronicznym w celu jego przech</div>	 
...
setTimeout("javascript:location.href='thanks.php'", 10000); 

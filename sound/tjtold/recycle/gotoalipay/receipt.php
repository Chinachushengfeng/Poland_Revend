...
<div align="center" style="font-size:20px">  <?php echo selectword('take photo');?>   </div>	 
 	...
 	<div align="center">
<a  href="../thanks.php?fundorderid=<?php echo $_GET['fundorderid']; ?>"><img src="../images/gou.gif?<?php echo rand(1,9999);?>" style="border-radius:70%;margin-top:5%" width=10% ></img> </a>
   </div>  
...
setTimeout("javascript:location.href='../thanks.php?fundorderid=<?php echo $_GET['fundorderid']; ?>'", 10000); 

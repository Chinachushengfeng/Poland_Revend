...
elseif ($returncode=="100050"  )
{
	...
	$codestr=" 機器故障，請致電技術支援 熱線 94880277<br>Machine out of order. <br>Please contact Technical Service <br>Hotline on 94880277 for assistance";
...
echo '   <div style="font-size:25px;text-align:center;margin-top:20px">請重試 <br> (八達通號碼:'.$userscan.') <br>';
	   ...
	   {
		    echo '<a href="index.php"> <input type="button" id="daojishi" class="btn2"  style="width:25%;margin-left:37%;font-size:35px"  value="還剩22秒 " disabled="disabled" /> </a>';
	   }
	   else
	   {

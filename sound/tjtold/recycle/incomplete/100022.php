...
$sql="update user_transaction set transactiondone=2 where transactionid='$transactionid'  ";   //標記2
 ...
 <a href="100022endfail.php"> <input type="button" id="daojishi" class="btn"  style="width:25%;margin-left:37%;font-size:35px"  value="剩餘22秒" disabled="disabled" /> </a>
					...
					// window.location.href='success.php?qty=<?php echo $qty;?>';   
								...
								// window.location.href='100022.php?returncode=' + data.text;   
								  ...
								  if (cishu>1 || (parseInt(data.text)>100000 && parseInt(data.text)!=100022  )  )
								  {
									 ...
									 document.getElementById("errormsg").innerHTML=" 機器故障，請致電技術支援熱線：94880277 <br>Machine out of order. <br>Please contact Technical Service Hotline on 94880277 for assistance"+document.getElementById("errormsg").innerHTML;

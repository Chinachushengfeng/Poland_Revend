...
$resulttotalvalue1=mysqli_num_rows($resulttotalvalue1);
 ...
 header("Location:http://127.0.0.1/tjt"); 
...
$userscan=$result['userscan'];  
	...
	//echo '   <div  style="top:72%;left:51%;position:absolute;transform:translate(-50%,-50%);color:white;font-size:18px">   请使用登錄時八達通號碼： ('.$userscan.') 拍卡 增值金額：$'.$qty*0.1 . '   ';
	
	//echo '     Please use the Octopus card('.$userscan.')to rebate: $'.$qty*0.1 .'</div> ';

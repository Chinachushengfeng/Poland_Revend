...
//} 
 ...
 $sql="insert into user_transaction  (user,transactionid,dateline,statecode,barcode,metal,weight,bors,diam,recognitionstatus,charityid,rebateordonate,bottlevalue,payplatform,charityname,octreceipt) 
			  
			  values ('$user','$transactionid','$dateline','$statecode','$barcode','$metal','$weight','$bors','$diam','1','$charityid','$rebateordonate','$bottlevalue','$payplatform','$charityname','$octreceipt')";
			 ...
			 mysqli_query($link,$sql);	 
			  ...
			  $sql="update command set recognitionstatus=0 ,diam=0,weight=0,thetype=0";
			 mysqli_query($link,$sql);	 

...
elseif ($returncode=="100019" ||$returncode=="100024" || $returncode=="100021" || $returncode=="100035" )
{
	 ...
	 $codestr="機器故障。<br> Machine Out Of Order. <br>請致電技術支援熱線 94880277 <br>Please contact Technical Service<br>Hotline on 94880277 for assistance</br>";
}
...
$url="../../index.php";
 ...
 ?>
	 ...
	 Error
	<div style="font-size:25px;text-align:center">  <?php echo $returncode;?> </div>	 
	 </td>
	 </tr>
	  <tr align="center"  >

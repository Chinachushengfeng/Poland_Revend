...
<div id="particles">
 ...
 <body leftmargin=0 topmargin=0 oncontextmenu='return false' ondragstart='return false' onselectstart='return false' onselect='document.selection.empty()' oncopy='document.selection.empty()' onbeforecopy='return false'>
     ...
     <a href="http://127.0.0.1/tjt/login/alipaylogin/gotoscan.php" class="btn bottombtn" style='margin-left:-15px'>
 POCZĄTEK
	</a>
...
$sql = "update command set charityid ='',userscan='0' ";
...
// getcharity?lang=zh
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://188.125.156.176:8080/groszek/public/urlget/user_transaction.php'); //這裏是判斷網絡狀況
...
$errorcode = $result['errorcode'];
 ...
 if ($errorcode & 0x10  || $errorcode & 0x20 || $errorcode & 0x80  )
 {
...
$auth_url = "http://188.125.156.176:8080/groszek/public/urlget/getbarcode.php?mid=".$mid; 
$ch = curl_init();
...
if(!$totalbottlevalue)
{
 ...
 $info['errorcode'] = $errorcode;
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'http://188.125.156.176:8080/groszek/public/urlget/user_transaction.php'); //這裏要做壹個接受中斷數據的接口
    curl_setopt($ch, CURLOPT_POST, 1);
    curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_TIMEOUT, 28);
...
$auth_url = "http://188.125.156.176:8080/groszek/public/urlget/getnewad.php?mid=".$result['mid'] ;
